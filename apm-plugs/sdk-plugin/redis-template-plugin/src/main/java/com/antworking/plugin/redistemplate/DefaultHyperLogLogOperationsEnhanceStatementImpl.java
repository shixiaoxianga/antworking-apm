...
public class DefaultHyperLogLogOperationsEnhanceStatementImpl extends AbstractEnhanceStatement {

    @Override
    public ElementMatcher<? super TypeDescription> doMatcherClass() {
        return ElementMatchers.named("org.springframework.data.redis.core.DefaultHyperLogLogOperations");
    }
