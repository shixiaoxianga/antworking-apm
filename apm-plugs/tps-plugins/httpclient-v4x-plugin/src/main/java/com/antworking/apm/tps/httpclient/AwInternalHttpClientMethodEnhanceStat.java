...
public class AwInternalHttpClientMethodEnhanceStat extends AbstractDynamicVariableEnhanceStatement {
    @Override
    public ElementMatcher<? super TypeDescription> doMatcherClass() {
        return ElementMatchers.named("org.apache.http.impl.client.InternalHttpClient");
    }
    ...
    public DynamicType.Builder<?> doDefine(DynamicType.Builder<?> builder,
        ...
        return builder.method(doMatcherMethod())
                .intercept(MethodDelegation.to(new AwObjectMethodIntercept(new AwInternalHttpClientMethodIntercept())));
    }
}
